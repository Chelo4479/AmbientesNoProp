...
$provincias_cantones_parroquias = array (
  1 => 
  array (
    'provincia' => 'AZUAY',
    'cantones' => 
...
echo'</br>';
echo '<h1>Provincias - Cantones - Parroquias</h1>';
echo'</br>';
echo '<table border="1">';
echo '<thead>';
...
{
echo'<option  value="cantones">'.($provincia['provincia']).'</option>';
}
